            ...
            {loading ? (
              ...
              projects.map(proj => (
                <div
                  ...
                  className={`bg-white border rounded-2xl p-5 cursor-pointer hover:shadow-md transition-all dark:bg-hal-darkCard dark:border-hal-darkBorder/40 ${
                    selectedProject?._id === proj._id ? 'border-sky-400 dark:border-sky-850 bg-sky-50/10' : 'border-slate-200/80'
                  }`}
                >
                  ...
                  {selectedProject.milestones?.map((m, idx) => {
                    ...
                    return (
                      <div key={idx} className="relative text-xs">
                        ...
                        {/* Node bullet */}
                        <span className={`absolute -left-[20.5px] top-0.5 h-3.5 w-3.5 rounded-full border-2 flex items-center justify-center ${
                          m.completed ? 'bg-sky-400 border-sky-400 text-slate-950' : 'bg-slate-50 border-slate-300 dark:bg-hal-darkCard dark:border-slate-700'
                        }`}></span>
