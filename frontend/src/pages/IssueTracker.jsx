                  ...
                  <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-3">
                    <div className="space-y-1">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className={`text-[9px] px-2 py-0.5 rounded font-bold uppercase ${item.priority === 'Critical' ? 'bg-red-500/10 text-red-500 border border-red-500/20' :
                  ...
                  return (
                    <>
                      ...
                      <div className="relative flex justify-between items-center mt-3 pt-2">
                        ...
                        <div className="flex flex-col items-center gap-1 z-10">
                          <div className={`h-6 w-6 rounded-full font-bold flex items-center justify-center text-[8px] border-2 border-white dark:border-hal-darkCard ${activeLevel >= 1 ? 'bg-amber-500 text-slate-950' : 'bg-slate-200 text-slate-400 dark:bg-slate-800 dark:text-slate-500'
                            }`}>L1</div>
                        ...
                        {/* Node 3: PM (48h) */}
                        <div className="flex flex-col items-center gap-1 z-10">
                          <div className={`h-6 w-6 rounded-full font-bold flex items-center justify-center text-[8px] border-2 border-white dark:border-hal-darkCard ${activeLevel >= 2 ? 'bg-orange-500 text-slate-950 animate-pulse' : 'bg-slate-200 text-slate-400 dark:bg-slate-800 dark:text-slate-500'
                            }`}>L2</div>
                        ...
                        <div className="flex flex-col items-center gap-1 z-10">
                          <div className={`h-6 w-6 rounded-full font-bold flex items-center justify-center text-[8px] border-2 border-white dark:border-hal-darkCard ${activeLevel >= 3 ? 'bg-red-500 text-slate-950 animate-bounce' : 'bg-slate-200 text-slate-400 dark:bg-slate-800 dark:text-slate-500'
                            }`}>L3</div>
